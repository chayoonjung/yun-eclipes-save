...
import com.projectone.vo.PeopleVO;

@WebServlet(urlPatterns = {"/demo/pop"})
public class PeopleServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String path = "http://127.0.0.1:5000/demo/sg-pop";
		...
		String result = "";
		 ...
		 if (status == 200) {
			 ...
			 BufferedReader br = new BufferedReader(isr);
				...
				Gson gson = new Gson();
//				
				PeopleVO[] peopleList = gson.fromJson(reader, PeopleVO[].class);
...
//			 }
		...
		conn.disconnect();
		 ...
		 // 브라우저에 응답
		RequestDispatcher rd = req.getRequestDispatcher("/WEB-INF/views/people-list.jsp");
		rd.forward(req, resp);
